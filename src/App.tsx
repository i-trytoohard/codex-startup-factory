      ...
      <section className="app-shell">
        <header className="tinder-topbar">
          <div className="brand-lockup">
            ...
            <div>
              <span className="eyebrow">Political Leaning</span>
              <strong>Manifesto Match</strong>
            </div>
          </div>

          <div className="topbar-pills">
            <span className="meta-pill strong">{region.cityLabel}</span>
          </div>
        </header>

        <section className="hero-panel">
          <div className="hero-copy">
            <span className="eyebrow">Swipe demo</span>
            <h1>Like Tinder, but for political propaganda.</h1>
            <p>
              Swipe manifesto pitches the way you would swipe profiles, then reveal the political personality and leaning that best matches your instinct.
            </p>
          </div>

          <div className="hero-meta">
            <div className="meta-pill">Right = resonates</div>
            <div className="meta-pill">Left = reject</div>
            <div className="meta-pill">Demo data only</div>
          </div>

          <p className="hero-note">{region.note}</p>
        </section>

        <section className="session-strip" aria-label="Session overview">
          <article className="session-pill">
            <span>Deck</span>
        ...
        <section className="swipe-stage">
          ...
          <div className="card-stack">
            ...
            {!completed && currentCard ? (
              ...
              >
                <div className={`swipe-indicator ${dragX > 40 ? 'visible support' : ''}`}>Match</div>
                <div className={`swipe-indicator ${dragX < -40 ? 'visible pass' : ''}`}>Nope</div>

                <div className="manifesto-gradient" />

                <div className="manifesto-photo-layer" aria-hidden="true">
                  <div className="photo-badge">{currentCard.issueTag}</div>
                  <div className="photo-party">{currentCard.party}</div>
                </div>
          ...
          {!completed ? (
            <div className="action-row tinder-actions">
              <button className="action-button dismiss" onClick={() => handleDecision('pass')} aria-label="Swipe left">
                x
              </button>
              <button className="action-button rewind" aria-label="Info">
                i
              </button>
              <button className="action-button approve" onClick={() => handleDecision('support')} aria-label="Swipe right">
                ♥
              </button>
            </div>
          ) : null}
        ...
        <section className="bottom-sheet">
          <section className="insight-card">
            ...
            <h2>What your swipes are saying</h2>
          ...
          <section className="insight-card muted">
            <span className="eyebrow">Why it demos well</span>
            <ul className="notes-list">
              <li>Feels familiar immediately because the interaction model is Tinder-like</li>
              <li>Keeps all attention on one strong card instead of analytics-heavy panels</li>
              <li>Still surfaces a personality result that is fun to screenshot and share</li>
            </ul>
          </section>
        </section>
      </section>
